...
?>
<div class="trx_addons_admin_notice update-nag">
	<?php
	// Theme image
	...
	<div class="trx_addons_admin_notice_buttons">
		...
		// Dismiss
		?>
		<a href="#" data-notice="skins" class="trx_addons_hide_notice"><i class="dashicons dashicons-dismiss"></i> <span class="trx_addons_hide_notice_text"><?php esc_html_e( 'Dismiss', 'trx_addons' ); ?></span></a>
	</div>
</div>

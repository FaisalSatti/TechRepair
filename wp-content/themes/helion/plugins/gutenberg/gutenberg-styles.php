...
if ( ! function_exists( 'helion_gutenberg_add_theme_vars' ) ) {
	add_filter( 'helion_filter_add_theme_vars', 'helion_gutenberg_add_theme_vars', 10, 2 );
	function helion_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'helion_gutenberg_get_css' ) ) {
	add_filter( 'helion_filter_get_css', 'helion_gutenberg_get_css', 10, 2 );
	function helion_gutenberg_get_css( $css, $args ) {

...
if ( ! function_exists( 'helion_trx_addons_add_theme_vars' ) ) {
	add_filter( 'helion_filter_add_theme_vars', 'helion_trx_addons_add_theme_vars', 10, 2 );
	function helion_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'helion_trx_addons_get_css' ) ) {
	add_filter( 'helion_filter_get_css', 'helion_trx_addons_get_css', 10, 2 );
	function helion_trx_addons_get_css( $css, $args ) {
...
.portfolio_page_content_wrap .portfolio_page_featured > img,
.sc_price_item,
...
.widget_slider .slider_wrap .slider_container,
.trx_addons_scroll_to_top,
.trx_addons_audio_player,
.trx_addons_video_player.with_cover,
.sc_button:not(.sc_button_simple):not([class*="sc_button_plain"]),
.sc_form button,
...
.trx_addons_audio_player.with_cover .trx_addons_audio_player_image {
	-webkit-border-radius: {$vars['rad']} 0 0 {$vars['rad']};
	    -ms-border-radius: {$vars['rad']} 0 0 {$vars['rad']};
			border-radius: {$vars['rad']} 0 0 {$vars['rad']};
}

@media (max-width: 767px) {
    .trx_addons_audio_player.with_cover .trx_addons_audio_player_image {
        -webkit-border-radius: {$vars['rad']} {$vars['rad']} 0 0;
            -ms-border-radius: {$vars['rad']} {$vars['rad']} 0 0;
                border-radius: {$vars['rad']} {$vars['rad']} 0 0;
    }
}
...
.services_more_link .more_link_icon,
.portfolio_more_link .more_link_icon,
...
.sc_services_light .sc_services_item_button .services_more_link {
	-webkit-border-radius: {$vars['rad20']};
	    -ms-border-radius: {$vars['rad20']};
			border-radius: {$vars['rad20']};
}
...
.sc_blogger_news_modern .post_featured, 
.sc_blogger_news_modern .post_featured .mask, 
.sc_blogger_news_modern .post_featured > img, 
.sc_blogger_news_announce .post_featured, 
.sc_blogger_news_announce .post_featured .mask, 
.sc_blogger_news_announce .post_featured > img, 
...
.trx_addons_title_with_link a:hover {
...
.trx_addons_hover_mask {
	background: {$colors['inverse_dark_08']};
}
...
.trx_addons_tiny_font > a {
    color: {$colors['text']};
}
.trx_addons_tiny_font > a:hover {
    color: {$colors['text_dark']};
}
.footer_wrap .trx_addons_tiny_font > a,
.scheme_self.footer_wrap .trx_addons_tiny_font > a {
    color: {$colors['alter_text']};
}
.footer_wrap .trx_addons_tiny_font > a:hover,
.scheme_self.footer_wrap .trx_addons_tiny_font > a:hover {
    color: {$colors['alter_dark']};
}
...
.slider_container.slider_multi .slider-slide .slide_info .slide_cats a,
.slider_container .slider-slide .slide_info:not(.slide_info_large) .slide_cats a {
    color: {$colors['inverse_light']};
}
.slider_container.slider_multi .slider-slide .slide_info .slide_cats a:hover,
.slider_container .slider-slide .slide_info:not(.slide_info_large) .slide_cats a:hover {
    color: {$colors['text_dark']};
}
...
.slider_container.slider_multi .slider-slide .slide_title a,
.slider_container .slider-slide .slide_info:not(.slide_info_large) .slide_title a {
    color: {$colors['text_dark']};
}
.slider_container.slider_multi .slider-slide .slide_title a:hover,
.slider_container .slider-slide .slide_info:not(.slide_info_large) .slide_title a:hover {
    color: {$colors['text']};
}
...
.slider_titles_lb.slider_container.slider_multi .slider-slide .slide_title:hover:after,
.slider_titles_lb.slider_container .slider-slide .slide_info:not(.slide_info_large) .slide_title:hover:after {
    color: {$colors['text_hover']};
}
...
.slider_titles_rb.slider_container.slider_multi .slider-slide .slide_title:hover:after,
.slider_titles_rb.slider_container .slider-slide .slide_info:not(.slide_info_large) .slide_title:hover:after {
    color: {$colors['text_hover']};
}
.sc_slider_controls .slider_controls_wrap > a {
	color: {$colors['text_dark']};
...
.ua_ie .footer_wrap .widget_contacts .contacts_info span.contacts_email > a.underline_hover,
.ua_ie .scheme_self.footer_wrap .widget_contacts .contacts_info span.contacts_email > a.underline_hover {
    background-image: linear-gradient(to right,  {$colors['alter_text']} 0%,  {$colors['alter_text']} 100%);
}
...
.widget_twitter .widget_content .sc_twitter_list li:hover:before {
	color: {$colors['text_link']} !important;
}
...
.scheme_self.sidebar .widget_twitter .widget_content .sc_twitter_list li + li {
...
.sc_item_title_style_decoration.sc_item_subtitle:before {
    background-color:{$colors['text_link']};	
}
.color_style_link2 .sc_item_title_style_decoration.sc_item_subtitle:before {
    background-color:{$colors['text_link2']};	
}
.color_style_link3 .sc_item_title_style_decoration.sc_item_subtitle:before {
    background-color:{$colors['text_link3']};	
}
.color_style_dark .sc_item_title_style_decoration.sc_item_subtitle:before {
    background-color:{$colors['text_dark']};	
}
...
.sc_item_featured .post_info_tl a,
.sc_item_featured .post_info_tc a,
.sc_item_featured .post_info_tr a,
.sc_item_featured .post_info_ml a,
.sc_item_featured .post_info_mc a,
.sc_item_featured .post_info_mr a,
.sc_item_featured .post_info_bl a,
.sc_item_featured .post_info_bc a,
.sc_item_featured .post_info_br a { 
	color:{$colors['text_link']};
}
.sc_item_featured .post_info_tl a:hover,
.sc_item_featured .post_info_tc a:hover,
.sc_item_featured .post_info_tr a:hover,
.sc_item_featured .post_info_ml a:hover,
.sc_item_featured .post_info_mc a:hover,
.sc_item_featured .post_info_mr a:hover,
.sc_item_featured .post_info_bl a:hover,
.sc_item_featured .post_info_bc a:hover,
.sc_item_featured .post_info_br a:hover {
	color:{$colors['text_hover']};
}
...
.sc_blogger_default .sc_blogger_item .sc_blogger_item_title a {
    color: {$colors['alter_dark']};
}
...
[class*="over_bottom_left"] .sc_item_featured [class*="post_info_"] .post_meta_item {
    background-color: {$colors['bg_color']};
}
[class*="over_bottom_left"] .sc_item_featured [class*="post_info_"] .post_meta_item a {
	color:{$colors['inverse_light']};
}
[class*="over_bottom_left"] .sc_item_featured [class*="post_info_"] .post_meta_item a:hover {
	color:{$colors['text_dark']};
}
[class*="over_bottom_left"] .sc_item_featured [class*="post_info_"] .entry-title {
    background-color: {$colors['bg_color']};
}
[class*="over_bottom_left"] .sc_item_featured [class*="post_info_"] .entry-title a {
  	color:{$colors['text_dark']};	
}
[class*="over_bottom_left"] .sc_item_featured [class*="post_info_"] .entry-title a:hover { 
  	color:{$colors['text']};	
}
[class*="over_bottom_left"] .sc_item_featured [class*="post_info_"] .entry-title a:after {
  	color:{$colors['text_link']};	
}
[class*="over_bottom_left"] .sc_item_featured [class*="post_info_"] .entry-title a:hover:after {
  	color:{$colors['text_hover']};	
}
...
[class*="category_center"] .sc_item_featured .post_info_mc .entry-title  a {
    color:{$colors['text_dark']};		
}
[class*="category_center"] .sc_item_featured .post_info_mc .entry-title  a:hover {
    color:{$colors['text']};		
}
[class*="category_center"] .sc_item_featured .post_info_mc .post_meta_item,
[class*="category_center"] .sc_item_featured .post_info_mc .post_meta_item a {
    color:{$colors['inverse_light']};	
}
[class*="category_center"] .sc_item_featured .post_info_mc .post_meta_item a:hover {
    color:{$colors['text_dark']};	
}
...
/* layout Default - template 'Category Top' */
...
.sc_blogger_item_default_category_top .post_featured:before {
    background: {$colors['text_dark_06']};
}
.sc_blogger_item_default_category_top .post_featured:after {
...
.sc_blogger_item_default_category_top:hover .sc_blogger_item_title a {
	color:{$colors['inverse_hover']};
}
...
.sc_blogger_item_default_category_top:hover .post_meta_item {
    color:{$colors['inverse_hover']};	
}
.sc_blogger_item_default_category_top .post_meta_item.post_categories,
.sc_blogger_item_default_category_top .post_meta_item.post_categories a {
    color:{$colors['text_link']};	
}
.sc_blogger_item_default_category_top:hover .post_meta_item.post_categories,
.sc_blogger_item_default_category_top:hover .post_meta_item.post_categories a {
    color:{$colors['extra_link']};	
}


/* layout Default - template 'Category Top Extra' */
...
.sc_blogger_item_default_category_top_extra .sc_blogger_item_title a:hover {
	color:{$colors['text']};
}
...
.sc_portfolio_default .sc_portfolio_item_title a {
	color: {$colors['text_dark']};
}
.sc_portfolio_default .sc_portfolio_item_title a:hover {
	color: {$colors['text']};
}
...
.sc_portfolio_default .sc_portfolio_item_button .portfolio_more_link:hover {
...
.sc_price_item {
	color: {$colors['alter_text']};
    -webkit-box-shadow: 0 0 4px {$colors['alter_dark_01']};
    -ms-box-shadow: 0 0 4px {$colors['alter_dark_01']};
    box-shadow: 0 0 4px {$colors['alter_dark_01']};
}
.sc_price_item:hover {
    -webkit-box-shadow: 0 0 8px {$colors['alter_dark_02']};
    -ms-box-shadow: 0 0 8px {$colors['alter_dark_02']};
    box-shadow: 0 0 8px {$colors['alter_dark_02']};
}
...
.sc_price_item .sc_price_item_description ul li:before,
...
.sc_services_default .sc_services_item_button .services_more_link:hover {
    color: {$colors['alter_link']} !important;
    background-color: transparent !important;
    border-color: transparent !important;
}
...
.sc_services_light .sc_services_item_button .services_more_link:hover {
    color: {$colors['alter_dark']} !important;
    background-color: transparent !important;
    border-color: transparent !important;
}
...
.sc_services_light .services_more_link:hover .more_link_icon {
    color: {$colors['alter_link']} !important;
    background-color:  {$colors['alter_bg_color']};
}
...
.sc_services_modern.color_style_link2 .sc_services_item_icon,
.sc_services_modern.color_style_link2 .sc_services_item_title a:hover,
.sc_services_modern.color_style_link2 .sc_services_item_subtitle a:hover {
	color: {$colors['text_link2']};
}
.sc_services_modern.color_style_link3 .sc_services_item_icon,
.sc_services_modern.color_style_link3 .sc_services_item_title a:hover,
.sc_services_modern.color_style_link3 .sc_services_item_subtitle a:hover {
	color: {$colors['text_link3']};
}
...
.sc_services_modern .sc_services_item .sc_services_item_button .sc_iconic_button:hover {
	color: {$colors['text_link']} !important;
}


.sc_services_modern .sc_services_item_button .sc_button,
.sc_services_modern .sc_services_item_button .sc_button:hover {
	color: {$colors['inverse_link']} !important;
}
...
.sc_services_modern .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_price .amount {
	color: {$colors['alter_dark']} !important;
}
...
.sc_services_modern .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_title,
...
.sc_services_modern.color_style_link2 .sc_services_item.with_image:hover .sc_services_item_header.without_image .sc_services_item_title a,
.sc_services_modern.color_style_link2 .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_title a:hover {
	color: {$colors['alter_link2']} !important;
}
.sc_services_modern.color_style_link3 .sc_services_item.with_image:hover .sc_services_item_header.without_image .sc_services_item_title a,
.sc_services_modern.color_style_link3 .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_title a:hover {
	color: {$colors['alter_link3']} !important;
}
.sc_services_modern .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_subtitle,
.sc_services_modern .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_subtitle a {
	color: {$colors['alter_link']} !important;
}
.sc_services_modern.color_style_link2 .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_subtitle,
.sc_services_modern.color_style_link2 .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_subtitle a {
	color: {$colors['alter_link2']} !important;
}
.sc_services_modern.color_style_link3 .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_subtitle,
.sc_services_modern.color_style_link3 .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_subtitle a {
	color: {$colors['alter_link3']} !important;
}
...
.sc_services_modern.color_style_link2 .sc_services_item.with_image:hover .sc_services_item_header.without_image .sc_services_item_subtitle a,
.sc_services_modern.color_style_link2 .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_subtitle a:hover {
	color: {$colors['alter_hover2']} !important;
}
.sc_services_modern.color_style_link3 .sc_services_item.with_image:hover .sc_services_item_header.without_image .sc_services_item_subtitle a,
.sc_services_modern.color_style_link3 .sc_services_item.with_image .sc_services_item_header.without_image .sc_services_item_subtitle a:hover {
...
.sc_services_modern .sc_services_item.with_image .sc_services_item_header.without_image .sc_iconic_button {
	color: {$colors['alter_dark']} !important;
}
.sc_services_modern .sc_services_item.with_image .sc_services_item_header.without_image .sc_iconic_button:hover {
	color: {$colors['alter_link']} !important;
}
...
.social_light .socials_wrap .social_item .social_icon,
.social_light .socials_wrap .social_item .social_icon i {
	color: {$colors['alter_light']};
}

.social_light .socials_wrap .social_item:hover .social_icon,
.social_light .socials_wrap .social_item:hover .social_icon i {
	color: {$colors['alter_dark']};
}
...
.scheme_self.sidebar .social_white .socials_wrap .social_item .social_icon,
.scheme_self.footer_wrap .social_white .socials_wrap .social_item .social_icon {
	color: {$colors['alter_dark']};
	background-color: transparent;
}
.scheme_self.sidebar .social_white .socials_wrap .social_item:hover .social_icon,
.scheme_self.footer_wrap .social_white .socials_wrap .social_item:hover .social_icon {
	color: {$colors['alter_dark']};
	background-color: transparent;
}
...
.sc_socials_names .socials_wrap .social_item:hover {
    color: {$colors['text']};
}
...
/*active slide */
body:not(.mobile_layout) .sc_testimonials_default .slider_container[data-slides-per-view="3"] .swiper-slide-active + .swiper-slide-next .sc_testimonials_item_content  {
    color: {$colors['inverse_link']};
    border-color: {$colors['text_link']}; 
    background-color:{$colors['text_link']};
}
body:not(.mobile_layout) .sc_testimonials_default .slider_container[data-slides-per-view="3"] .swiper-slide-active + .swiper-slide-next .sc_testimonials_item_content:after {
    border-color: {$colors['text_link']}; 
    background-color:{$colors['text_link']};
}
body:not(.mobile_layout) .sc_testimonials_default .slider_container[data-slides-per-view="3"] .swiper-slide-active + .swiper-slide-next .sc_testimonials_item_content:before {
    color: {$colors['inverse_link']};
}
...
.sc_testimonials_plain.color_style_link2 .sc_testimonials_item_content:after,
.sc_testimonials_plain.color_style_link2 .sc_testimonials_item_author_title {
	color: {$colors['text_link2']};
}
.sc_testimonials_plain.color_style_link3 .sc_testimonials_item_content:after,
.sc_testimonials_plain.color_style_link3 .sc_testimonials_item_author_title {
	color: {$colors['text_link3']};
}
.sc_testimonials_plain.color_style_dark .sc_testimonials_item_content:after,
.sc_testimonials_plain.color_style_dark .sc_testimonials_item_author_title {
	color: {$colors['text_dark']};
}
...
.sc_testimonials_classic.color_style_link2 .sc_testimonials_item_author_title {
	color: {$colors['text_link2']};
}
.sc_testimonials_classic.color_style_link3 .sc_testimonials_item_content:before,
.sc_testimonials_classic.color_style_link3 .sc_testimonials_item_author_title {
	color: {$colors['text_link3']};
}
.sc_testimonials_classic.color_style_dark .sc_testimonials_item_content:before,
.sc_testimonials_classic.color_style_dark .sc_testimonials_item_author_title {
	color: {$colors['text_dark']};
}
...
.team_member_page .team_member_details .team_member_details_value a {
   	color: {$colors['text']}; 
}
.team_member_page .team_member_details .team_member_details_value a:hover {
   	color: {$colors['text_dark']}; 
}
...
.sc_team_short .sc_team_item_excerpt {
   	color: {$colors['inverse_text']}; 
}
...
.scheme_self.sc_layouts_panel_inner {
    -webkit-box-shadow: 0 0 4px {$colors['text_dark_02']};
	-moz-box-shadow: 0 0 4px {$colors['text_dark_02']};
	box-shadow: 0 0 4px {$colors['text_dark_02']};
}

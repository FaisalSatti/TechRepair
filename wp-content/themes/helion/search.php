...
// Search page setup
// (uncomment lines with helion_storage_set_array2() calls if you want to override the relevant settings from Theme Options)
...
helion_storage_set_array( 'options_meta', 'blog_style', 'masonry_3' );

// Sidebar position:
// Replace the following parameter with one of values: none | left | right
helion_storage_set_array( 'options_meta', 'sidebar_position', 'none' );

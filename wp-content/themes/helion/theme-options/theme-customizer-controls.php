...
// 'info' field
//--------------------------------------------------------------------
class Helion_Customize_Info_Control extends WP_Customize_Control {
	public $type = 'info';
...
// 'hidden' field
//--------------------------------------------------------------------
class Helion_Customize_Hidden_Control extends WP_Customize_Control {
	public $type = 'hidden';
	...
	public function render_content() {
		...
		if ( 'last_option' == $this->id && helion_storage_get( 'need_footer_scripts', false ) ) {
			helion_storage_set( 'need_footer_scripts', false );
...
// 'button' field
//--------------------------------------------------------------------
class Helion_Customize_Button_Control extends WP_Customize_Control {
	public $type = 'button';
...
// 'switch' field
//--------------------------------------------------------------------
class Helion_Customize_Switch_Control extends WP_Customize_Control {
	public $type = 'switch';
	...
	public function render_content() {
		...
		<div class="customize-control-wrap">
			...
			?>
			<label class="customize-control-field-wrap helion_options_item_switch">
				<input type="hidden"
					<?php
					$this->link();
					if ( ! empty( $this->input_attrs['var_name'] ) ) {
...
// 'icon' field
//--------------------------------------------------------------------
class Helion_Customize_Icon_Control extends WP_Customize_Control {
	public $type = 'icon';
...
// 'checklist' field
//--------------------------------------------------------------------
class Helion_Customize_Checklist_Control extends WP_Customize_Control {
...
// 'scheme_editor' field
//--------------------------------------------------------------------
class Helion_Customize_Scheme_Editor_Control extends WP_Customize_Control {
			...
			/>
				...
				helion_show_layout(
					helion_show_custom_field(
						...
						$this->input_attrs,
						helion_unserialize( $this->input_attrs['value'] )
					)
				);
				?>
			</span>
...
// 'text_editor' field
//--------------------------------------------------------------------
class Helion_Customize_Text_Editor_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		helion_storage_set( 'need_footer_scripts', true );
	}
}
...
// 'range' field
//--------------------------------------------------------------------
class Helion_Customize_Range_Control extends WP_Customize_Control {
	public $type = 'range';
	...
	public function render_content() {
		...
		<div class="customize-control-wrap">
			...
			<span class="customize-control-field-wrap"><input type="<?php echo ! $show_value ? 'hidden' : 'text'; ?>" 
				...
				$this->link();
				if ( $show_value ) {
					echo ' class="helion_range_slider_value"';
				}
				if ( ! empty( $this->input_attrs['var_name'] ) ) {
					echo ' data-var_name="' . esc_attr( $this->input_attrs['var_name'] ) . '"';
				}

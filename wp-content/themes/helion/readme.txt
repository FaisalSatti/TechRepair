...
WordPress version: required at least 4.7, tested up to 5.2.4
...
Please install and activate it before starting to use the theme Helion.
...
Theme documentation is available on http://helion.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Helion is Fontello.

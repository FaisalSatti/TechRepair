	...
	<div class="sc_services_item_info">
		...
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			...
			if (!empty($link) && !empty($args['more_text'])) {
                ...
                <a href="<?php echo esc_url($link); ?>"<?php if (!empty($meta['link'])) echo ' target="_blank"'; ?> class="sc_button services_more_link">
                    <span class="more_link_icon"></span><span class="more_link_text"><?php echo esc_html($args['more_text']); ?></span>
                </a>
                </div><?php
			}
		}
